...
var valueNumber = "1999";

console.log('Task 1c', Number(valueNumber));
...
function hungryDog(lbs, age){
  if(age >= 1 && lbs <= 5 ){
    return lbs * 0.05;
  }else if(age >= 1 && lbs >= 6 && lbs <= 10){
    return lbs * 0.04;
  }else if(age >= 1 && lbs >= 11 && lbs && lbs <= 15){
    return lbs * 0.03;
...
console.log('Task 4', game('paper', 'paper'))
